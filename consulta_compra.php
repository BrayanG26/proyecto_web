                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese codigo compra" type="text" name="filtro" id="filtro" value="" size="20" maxlength="30" placeholder="Inserte un codigo de compra" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT codigo_compra, codigo_estado, fecha, valor FROM compras WHERE codigo_compra LIKE '$filtro%'";
                                                ...
                                                ?>
													<input  type="hidden"  name="codigo_compra"  value=<?PHP echo $codigo_compra;?> >
													<input  type="hidden"  name="codigo_estado"  value=<?PHP echo $codigo_estado;?> >
