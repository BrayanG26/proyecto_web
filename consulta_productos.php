                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese el producto" type="text" name="filtro" id="filtro" value="" size="20" maxlength="30" placeholder="Nombre del producto a buscar" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
