                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese codigo cliente" type="text" name="filtro" id="filtro" value="" size="20" maxlength="10" placeholder="Inserte el codigo del cliente" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT codigo_cliente, identificacion, nombres, apellidos FROM clientes WHERE codigo_cliente = '$filtro'";
                                                    $result1 = pg_query($conn,$consulta);
                                                    $numrows = pg_numrows($result1);
                                                    if($numrows!=0){
                                                        echo "<b> HAY UN ELEMENTO</b>";
