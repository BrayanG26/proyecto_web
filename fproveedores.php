<?PHP
    ...
    $insercion="insert into proveedores (codigo_proveedor, nombre, telefono, email, direccion, pais, ciudad, barrio, fecha_fundacion, fecha_contratacion ) 
                values ('$codigo_proveedor', '$nombre', '$telefono', '$email', '$direccion', '$pais', '$ciudad', '$barrio',
				'$fecha_fundacion' , '$fecha_contratacion')";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2>Incercion de datos correcta</h2>
