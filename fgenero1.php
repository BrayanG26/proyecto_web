                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="fgenero.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-4">
                                                            <input type="text" name="codigo_genero" id="codigo_genero" pattern="[0-9]{2}" maxlength="10" title="Solo permite numeros, de 2 cifras" autofocus placeholder="Codigo de genero" required/>
                                                        </div>
                                                        
                                                        <div class="name col-md-8">
                                                            <input type="text" name="nombre_genero" id="nombre_genero" placeholder="Nombre del Genero"  maxlength="30" required/>
                                                        </div>
                                                    </div>
