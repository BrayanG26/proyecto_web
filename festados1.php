                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="festados.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-4">
                                                            <input type="text" name="codigo_estado" id="codigo_estado" pattern="[0-9]{10}" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de estado" required/>
                                                        </div>
                                                        
                                                        <div class="name col-md-8">
                                                            <input type="text" name="nombre_estado" id="nombre_estado" placeholder="Nombre del Estado"  maxlength="30" required/>
                                                        </div>
                                                    </div>
