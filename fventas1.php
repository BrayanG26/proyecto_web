                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="fventas.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-6">
                                                            <input type="text" name="codigo_venta" id="codigo_venta" pattern="[0-9]{10}" maxlength="10" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de venta" required/>
                                                        </div>

                                                        <div class="name col-md-6">
                                                            <input type="text" name="codigo_estado" id="codigo_estado" pattern="[0-9]{10}" maxlength="10" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de estado" required/>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <br/><br/><p>Fecha de venta: </p>    
                                                        </div> 
                                                        <div class="col-md-4">
                                                                                                                       
                                                            <input type="date" name="fecha_venta" id="fecha_venta"  placeholder="Fecha de venta"/>
                                                        </div>
                                                        ...
                                                        <div class="name col-md-4">
                                                            <input type="text" name="valor_venta" id="valor_venta" maxlength="30" title="Escribe el valor de la venta" placeholder="Valor de venta" />
                                                        </div>
                                                    </div>
