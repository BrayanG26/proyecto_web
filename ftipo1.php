                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="ftipo.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-4">
                                                            <input type="text" name="codigo_tipo" id="codigo_tipo" pattern="[0-9]{10}" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de tipo" required/>
                                                        </div>
                                                        
                                                        <div class="name col-md-8">
                                                            <input type="text" name="nombre" id="nombre" placeholder="Nombre de Tipo"  maxlength="30" required/>
                                                        </div>
                                                    </div>
