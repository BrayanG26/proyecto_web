...
<html class="no-js" lang="es"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Iniciar Sesion - Erogames LTDA</title>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>EroGames</h2>
                                <span>Home / <a href="ingresar.php">Ingresar</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="consulta_ingresar.php" method="post" class="leave-comment">

                                                    <div class="row">
                                                        <?php 
                                                            if (isset($_GET["errorusuario"])=="si"){
                                                        ?> <div class="name col-md-1"></div>
                                                            <div class="alert alert-danger name col-md-10"><b>¡Error!</b> Datos incorrectos</div>
                                                            <div class="name col-md-1"></div>
                                                        <?php
                                                            }
                                                            else{
                                                        ...
                                                        <div class="name col-md-7">
                                                            <input title="Ingrese el nombre de usuario" type="text" name="username" id="username" value="" size="20" placeholder="Username" autofocus required/>
                                                        </div>
                                                        <div class="name col-md-5">
                                                            <input title="Ingrese la contraseña" type="password" name="password" id="password" value="" size="20" placeholder="Password" required/>
                                                        </div>
                                                    ...
                                                    <div class="name col-md-7 regtext">No estas registrado? <a href="registrarse.php" >Registrate Aquí</a>!</div>
                                                    <div class="name col-md-5 regtext"><a href="registrarse.php" >Olvidaste tu contraseña?</a>!</div>
                                                </form>
                                                <!-- Fin de Formulario-->
