                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="fcompras.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-6">
                                                            <input type="text" name="codigo_compra" id="codigo_compra" pattern="[0-9]{10}" maxlength="10" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de compra" required/>
                                                        </div>
                                                        ...
                                                        <div class="name col-md-6">
                                                            <input type="text" name="valor_compra" id="valor_compra"  maxlength="10" title="Ingrese el valor de la compra" placeholder="valor de la compra" />
                                                        </div>
