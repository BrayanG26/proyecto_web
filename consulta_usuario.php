                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>Eliminaciones</h2>
                                <span>Home / <a>Eliminaciones</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese el usuario" type="text" name="filtro" id="filtro" value="" size="20" maxlength="30" placeholder="Usuario a buscar" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT nombres, apellidos, usuario, clave, codigo_tipo FROM usuarios WHERE usuario LIKE '$filtro%'";
                                                    $result1 = pg_query($conn,$consulta);
                                                    $numrows = pg_numrows($result1);
													$row = pg_fetch_array($result1);
                                                    if($numrows!=0){
													
                                                        if($_SESSION["nombres"] == $row['nombres'] && $_SESSION["apellidos"] == $row['apellidos']){
														?>
															<div class="alert alert-danger name col-md-10"><b>¡Ups!</b> No se puede borrar ud mismo en este momento :( </div>
														<?php
														}else{
															if ($codigo_tipo=='01'){
                                                ...
                                                ?>
													...
													<input  type="hidden"  name="codigo_tipo"  value=<?PHP echo $codigo_tipo;?> >
                                                    </tbody>
                                                </table>
                                                    <div class="send">
