                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese el codigo_tipo" type="text" name="filtro" id="filtro" value="" size="20" maxlength="10" placeholder="Codigo de Tipo a buscar" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT * FROM tipos WHERE codigo_tipo LIKE '$filtro%'";
                                                ...
                                                ?>
                                                <h2>Resultado:</h2>
                                                <form method="post" action ="eliminar_tipo.php" >
                                                ...
                                                ?>
													<input  type="hidden"  name="tipo"  value=<?PHP echo $codigo;?> >
