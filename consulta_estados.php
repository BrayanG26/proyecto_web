                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese el estado" type="text" name="filtro" id="filtro" value="" size="20" maxlength="30" placeholder="Nombre del estado a buscar" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT * FROM estados WHERE nombre LIKE '$filtro%'";
                                                ...
                                                ?>
                                                <h2>Resultado:</h2>
                                                <form method="post" action ="eliminar_estados.php" >
