                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="fproductos.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-8">
                                                            <input type="text" name="codigo_producto" id="codigo_producto" pattern="[0-9]{10}" maxlength="10" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de producto" required/>
                                                        </div>

                                                        <div class="name col-md-4">
                                                            <input type="text" name="disponibilidad" id="disponibilidad"  pattern="[0-9]{1,5}" title="Es necesario saber la disponibilidad del producto" maxlength="5" placeholder="Disponibilidad" required/>
                                                        </div>
                                                        ...
                                                        <div class="name col-md-4">
                                                            <input type="text" name="precio" id="precio"  maxlength="10" placeholder="Precio" />
                                                        </div>
