                                    ...
                                    <div class="row">
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <!-- Formulario-->
                                                <form action="fproveedores.php" method="post" class="leave-comment">

                                                    <div class="row">

                                                        <div class="name col-md-4">
                                                            <input type="text" name="codigo_proveedor" id="codigo_proveedor" pattern="[0-9]{10}" title="Solo permite numeros, de 10 cifras" autofocus placeholder="Codigo de proveedor" required/>
                                                        </div>
                                                        ...
                                                        <div class="name col-md-4">
                                                            <input type="tel" name="telefono" id="telefono" maxlength="10" title="Solo permite numeros, de 10 cifras" placeholder="Telefono" />
                                                        </div>
                                                        ...
                                                        <div class="name col-md-4">
                                                            <input type="text" name="barrio" id="barrio" maxlength="30" title="Escribe el nombre de tu barrio" placeholder="Barrio" />
                                                        </div>

                                                        <div class="col-md-2">
                                                                <br/><br/><p>Fecha de fundacion: </p>    
                                                        </div> 
                                                        <div class="col-md-4">                                                           
                                                            <input type="date" name="fecha_fundacion" id="fecha_fundacion"  placeholder="Fecha de fundacion"/>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <br/><br/><p>Fecha de contratacion: </p>    
                                                        </div>
                                                        <div class="col-md-4">                                                           
                                                            <input type="date" name="fecha_contratacion" id="fecha_contratacion"  placeholder="Fecha de contratacion"/>
                                                        </div>
