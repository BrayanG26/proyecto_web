                                        ...
                                        <div class="col-md-8">  
                                            ...
                                            <div class="leave-form">
                                                ...
                                                <form action="" method="post" class="leave-comment">
                                                    ...
                                                    <div class="row">
                                                        <div class="name col-md-6">
                                                            <input title="Ingrese el producto" type="text" name="filtro" id="filtro" value="" size="20" maxlength="10" placeholder="Nombre del producto a buscar" autofocus required/>
                                                        </div>
                                                    </div>                        
                                                    <div class="send">
                                                ...
                                                if (isset($filtro)) {
                                                    ...
                                                    $consulta ="SELECT * FROM ventas WHERE codigo_venta = '$filtro'";
                                                ...
                                                ?>
                                                <h2>Resultado:</h2>
                                                <form method="post" action ="eliminar_ventas.php" >
