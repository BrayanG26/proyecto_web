...
ini_set('display_errors', 1);
    ...
    $incercion="insert into productos (codigo_producto, nombre, precio, disponibilidad ) values ('$codigo_producto', '$nombre', '$precio', '$disponibilidad')";
                                                
    $result = pg_query($conexion, $incercion);                                           
?> 
